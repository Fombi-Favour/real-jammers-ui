          ...
          <div className="flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420">
            ...
            {!videoAsset ? (
              ...
              <div className="relative h-full">
                <div className="flex w-full h-full justify-center items-center relative bg-white">
                ...
                <button
                  type="button"
                  className="absolute bottom-3 right-3 p-3 rounded-full bg-white text-xl text-gray-600 hover:text-white cursor-pointer outline-none hover:shadow-md transition-full duration-500 ease-in-out"
                  onClick={deleteVideo}
                >
                  <MdDelete />
                </button>
